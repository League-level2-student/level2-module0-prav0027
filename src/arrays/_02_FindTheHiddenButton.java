...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		String posint = JOptionPane.showInputDialog("Enter a positive number");
		int positive = Integer.parseInt(posint);
		...
		hiddenButton = rand.nextInt(positive);
...
buttons[hiddenButton].setText("ME");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(buttonClicked.getText().equalsIgnoreCase(" ")) {
